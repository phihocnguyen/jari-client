  ...
  return (
    ...
    >
      ...
      >
        ...
        <RecentActivityWidget projectId={projectId} recentActivity={data?.recentActivity} isLoading={isLoading} />
        ...
        <TeamWorkloadWidget projectId={projectId} teamWorkload={data?.teamWorkload} isLoading={isLoading} />
