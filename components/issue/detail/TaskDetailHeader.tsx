          ...
          >
            ...
            <button
              ...
              style={{
                background: 'transparent',
                border: 'none',
                borderLeft: isWatching ? '1px solid #b3d4ff' : '1px solid rgba(0, 0, 0, 0.1)',
                padding: '4px 6px',
                cursor: 'pointer',
                color: isWatching ? '#0c66e4' : '#44546f',
                fontSize: '0.8125rem',
          ...
          {watchersPopoverOpen && (
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 }}>
                <span style={{ fontSize: '0.8125rem', fontWeight: 600, color: '#172b4d' }}>
              ...
              {watchersList.length === 0 ? (
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 6, maxHeight: 150, overflowY: 'auto', marginBottom: 8 }}>
                  {watchersList.map((w) => (
                    <div key={w.id} style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: '0.8125rem' }}>
                      <div
                        style={{
                          width: 22,
                          height: 22,
                      ...
                      >
                        {(w.displayName || w.fullName || w.username || 'U').charAt(0).toUpperCase()}
                      </div>
                      <span style={{ color: '#172b4d', fontWeight: 500, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
              ...
              <div style={{ borderTop: '1px solid #ebecf0', paddingTop: 8, marginTop: 4 }}>
                <button
                  type="button"
                  onClick={() => {
                    handleToggleWatch();
